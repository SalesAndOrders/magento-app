...
class Config extends AbstractHelper{
    ...
    public function getStoreBaseUrl()
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_SYSTEM_STORE_BASE_URL, ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_SYSTEM_SECURE_BASE_URL, ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_SYSTEM_STORE_CODE, ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_SYSTEM_STORE_NAME, ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_SYSTEM_TIME_ZONE, ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_SYSTEM_COUNTRY, ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_SYSTEM_BASE_CURRENCY, ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return (string)$this->scopeConfig->getValue(
            self::XML_SYSTEM_DISPLAY_CURRENCY, ScopeInterface::SCOPE_STORE
        );
    }
