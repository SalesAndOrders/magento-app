...
class ActivationTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->integrationModel->expects($this->any())->method('load')->with($integrationName, 'name')->willReturn($this->integrationModel);
    ...
    public function testGetIntegration()
    {
        ...
        $this->integrationModel->expects($this->once())->method('load')->with($integrationName, 'name')->willReturn($this->integrationModel);
    ...
    public function testCreateIntegration()
    {
        ...
        $this->integrationManager->expects($this->any())->method('processIntegrationConfig')->with([$integrationName])->willReturn(array());
        $this->integrationFactory->expects($this->any())->method('create')->with()->willReturn($this->integrationModel);
        $this->integrationModel->expects($this->any())->method('load')->with($integrationName, 'name')->willReturn($this->integrationModel);
        $this->integrationModel->expects($this->any())->method('setSetupType')->with(2)->willReturn($this->integrationModel);
    ...
    public function testGetConsumer()
    {
        ...
        $this->oauthService->expects($this->any())->method('loadConsumer')->withAnyParameters()->willReturn($this->consumerModel);
    ...
    public function testActivateIntegration()
    {
        ...
        $this->logger->expects($this->at(0))->method('log')->with('Activating ...')->willReturn(array());
        $this->integrationModel->expects($this->once())->method('setStatus')->with(1)->willReturn($this->integrationModel);
        $this->integrationModel->expects($this->once())->method('setSetupType')->with(2)->willReturn($this->integrationModel);
        $this->consumerModel->expects($this->any())->method('getId')->with()->willReturn($this->consumerModel);
        $this->integrationModel->expects($this->once())->method('setConsumerId')->withAnyParameters()->willReturn($this->integrationModel);
        $this->integrationModel->expects($this->once())->method('save')->with()->willReturn($this->integrationModel);
        $this->logger->expects($this->at(1))->method('log')->withAnyParameters()->willReturn(array());
    ...
    public function testDeactivateIntegration()
    {
        ...
        $this->integrationModel->expects($this->any())->method('setStatus')->with('0')->willReturn($this->integrationModel);
        $this->integrationModel->expects($this->any())->method('save')->with()->willReturn($this->integrationModel);
        $this->integrationModel->expects($this->any())->method('getId')->with()->willReturn(10);
        $this->webHookModel->expects($this->any())->method('deleteWebHook')->with()->willReturn(true);
